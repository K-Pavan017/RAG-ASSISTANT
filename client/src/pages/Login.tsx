        ...
        <div style={{ textAlign: 'center', marginBottom: '8px' }}>
          <div style={{
            ...
            <svg width="28" height="28" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth="2">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 11c0-1.1.9-2 2-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M6 7c0-1.1.9-2 2-2h2a2 2 0 012 2v2a2 2 0 01-2 2H8a2 2 0 01-2-2V7z" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M6 15c0-1.1.9-2 2-2h2a2 2 0 012 2v2a2 2 0 01-2 2H8a2 2 0 01-2-2v-2z" />
            </svg>
          </div>
        </div>
